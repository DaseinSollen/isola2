!function(r) {
  ...
  var g = false, w = function() {
    ...
    return "none" !== o || (o = ""), r.css({ "-webkit-transform": "translateY(" + t + "px)" + o, "-moz-transform": "translateY(" + t + "px)" + o, transform: "translateY(" + t + "px)" + o, transition: "transform 0.6s cubic-bezier(0, 0, 0, 1) 0s", "will-change": "transform" });
  }, k = function(r, t, o) {
    return "none" !== o || (o = ""), r.css({ "-webkit-transform": "translateX(" + t + "px)" + o, "-moz-transform": "translateX(" + t + "px)" + o, transform: "translateX(" + t + "px)" + o, transition: "transform linear", "will-change": "transform" });
  }, y = function(r, t, o) {
  ...
  m.fn.paroller = function(d) {
    ...
    return this.each(function() {
      ...
      "background" === c ? "vertical" === f ? v(t, s) : "horizontal" === f && x(t, s) : "foreground" === c && ("vertical" === f ? b(t, l, i) : "horizontal" === f && k(t, l, i)), m(window).on("resize", function() {
        var r2 = m(this).scrollTop();
        o = m(window).width(), n = t.offset().top, a = t.outerHeight(), u = y(t, o, d), s = Math.round(n * u), l = Math.round((n - p / 2 + a) * u), g || (window.requestAnimationFrame(w), g = true), "background" === c ? (X(t), "vertical" === f ? v(t, s) : "horizontal" === f && x(t, s)) : "foreground" === c && r2 <= h && (j(t), "vertical" === f ? b(t, l) : "horizontal" === f && k(t, l));
      }), m(window).on("scroll", function() {
        var r2 = m(this).scrollTop();
        h = m(document).height(), s = Math.round((n - r2) * u), l = Math.round((n - p / 2 + a - r2) * u), g || (window.requestAnimationFrame(w), g = true), "background" === c ? "vertical" === f ? v(t, s) : "horizontal" === f && x(t, s) : "foreground" === c && r2 <= h && ("vertical" === f ? b(t, l, i) : "horizontal" === f && k(t, l, i));
      });
    });
  };
});
